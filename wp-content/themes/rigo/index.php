...
<html>
    ...
    <body>
        ...
        <h1>Hello from <?php echo $args['name']; ?>!</h1><small><?php echo $args['date']; ?></small>
        ...
        <ul>
            ...
            <li>This is a endpoint: GET: <a href="<?php echo get_site_url(); ?>/wp-json/sample_api/v1/cars">/cars</a></li>
